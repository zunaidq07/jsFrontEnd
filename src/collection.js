import removeMovie from './delete.js';
// export {addToList,collectionList,addNewList,view,displayList,displayCollection};
export function addToList(id,movieName,listName){
...
export function collectionList(str){
	console.log('kjhuiu');
	console.log(str);
	var htmlString = `<ul>`;
	if(list.length != 0){
...
export function addNewList(str){
...
export function displayCollection(n){
